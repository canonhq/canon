...
- [x] Display Auth0 organization ID in debug/details section (when organization mode is enabled)
...
- [x] Implement responsive layout (single column on mobile, two columns on desktop)
