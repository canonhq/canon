...
DESCRIPTIONS: dict[str, str] = {
    ...
    "status": "Show spec coverage dashboard. Displays per-spec and aggregate coverage metrics.",
    ...
    "verify": "Verify acceptance criteria against the codebase using Claude. Reports which ACs are realized, partial, or not found.",
